...
const styles = StyleSheet.create({
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: '#0F172A', color: 'white', fontFamily: 'Helvetica-Bold', fontSize: 9, padding: 6, borderBottom: '1px solid #E5E7EB' },
  ...
  rubricaContainer: { marginTop: 30, alignItems: 'center', },
  rubricaBox: { paddingVertical: 8, paddingHorizontal: 20, borderRadius: 8, borderWidth: 1.5, },
  rubricaText: { fontFamily: 'Helvetica-Bold', fontSize: 18, },
...
const getRubricaStyle = (rubrica: string) => {
    switch (rubrica.toLowerCase()) {
      case 'excelente': return { backgroundColor: '#ECFDF5', borderColor: '#10B981', color: '#065F46' };
      case 'aceptable': return { backgroundColor: '#EFF6FF', borderColor: '#60A5FA', color: '#1E40AF' };
      case 'necesita mejorar': return { backgroundColor: '#FEF9C3', borderColor: '#FBBF24', color: '#854D0E' };
      case 'bajo desempeño': return { backgroundColor: '#FFF7ED', borderColor: '#FB923C', color: '#9A3412' };
      case 'medidas correctivas': return { backgroundColor: '#FEF2F2', borderColor: '#F87171', color: '#991B1B' };
    ...
    return (
        <Document>
            ...
            <View style={styles.metaInfo}>
                ...
                <View style={styles.metaBox}><Text style={styles.metaLabel}>Evaluado por:</Text><Text style={styles.metaValue}>{report.evaluator?.name || 'N/A'}</Text></View>
                <View style={styles.metaBox}>
                    <Text style={styles.metaLabel}>Mes de evaluación:</Text>
                    {/* ✅ CORRECCIÓN: Se combinan los estilos en un array */}
                    <Text style={[styles.metaValue, {textTransform: 'capitalize'}]}>{monthName}</Text>
                </View>
