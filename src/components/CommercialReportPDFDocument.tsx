...
// --- ESTILOS PARA EL PDF (Light Mode) ---
...
export const CommercialReportPDFDocument = ({ report }: { report: CommercialReportData }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.totalRow}><Text style={styles.totalLabel}>TOTAL DE EVALUACIÓN</Text><Text style={styles.totalValue}>{(report.totalScore || 0).toFixed(2)}</Text></View>
