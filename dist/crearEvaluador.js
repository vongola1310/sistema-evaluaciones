...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var usersWithHashedPasswords, createdUsers;
        var _this = this;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(usersToCreate.map(function (user) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, bcryptjs_1.default.hash(user.password, 10)];
                                    case 1:
                ...
                case 1:
                    usersWithHashedPasswords = _a.sent();
                ...
                case 2:
                    ...
                    console.log("\u2705 Se crearon ".concat(createdUsers.count, " nuevos usuarios evaluadores."));
                    return [2 /*return*/];
            }
        });
    });
